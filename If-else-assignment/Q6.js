...
if(n1>n2) {
    ...
    console.log(`max number in ${n1}, ${n2}, is: ${n2}`);
} if(n1<n2) {
    console.log(`min number in ${n1}, ${n2}, is: ${n1}`);
} else {
    console.log(`min number in ${n1}, ${n2}, is: ${n2}`);
} 

if(n1>0 && 0<n2){
    if(n1%n2 === 0){
    console.log(`${n1} is exactly divisible`);
} else{
    console.log(`${n1} not divisible`);
}
} else{
